...
class WelcomePage extends AbstractWelcomePage<IProps> {
    ...
    constructor(props: IProps) {
      ...
      */
        ...
        this._checkAuthStatus = this._checkAuthStatus.bind(this);
        this._handleAuthCallback = this._handleAuthCallback.bind(this);
    }
                    ...
                    <div className = 'header-container'>
                        ...
                        {!this._isAuthenticated && (
                            <div style={{
                                ...
                                <span style={{ color: '#856404', fontSize: '14px' }}>
                                    Please sign in with ZITADEL to start or join meetings.
                                </span>
                            </div>
                        )}
                        ...
                        <div id = 'enter_room'>
                            <div className = 'join-meeting-container'>
                                ...
                                <button
                                    aria-disabled = { !this._isAuthenticated ? 'true' : 'false' }
                                    ...
                                    style={{
                                        opacity: this._isAuthenticated ? 1 : 0.5,
                                        cursor: this._isAuthenticated ? 'pointer' : 'not-allowed'
                                    }}
                                    tabIndex = { 0 }
                                    type = 'button'>
    ...
    _onFormSubmit(event: React.FormEvent) {
        ...
        // Check authentication before allowing to join
        if (!this._isAuthenticated) {
            alert('Please sign in first to start a meeting.');
            return;
        }
